...
?>
      ...
      <div class="row">
        <div class="col-lg-6 home-left">
          ...
          <?php endif; ?>
            ...
            <button type="button" class="btn btn-light button-white mr-5" onclick="window.location.href='<?php echo get_theme_mod('btn1_link', '#portfolio'); ?>'"><?php echo get_theme_mod('btn1_title', 'Portfolio'); ?></button>
    ...
    <div class="container" id="portfolio">
      <div class="col-lg-6 mb-5">
        <p class="sections-title" id="portfolio-title"><?php echo get_theme_mod('portfolio_title', 'My Work'); ?></p>
        <p class="description"><?php echo get_theme_mod('portfolio_description', 'These are all my projects that I have worked on so far'); ?></p>
      </div>

        <ul class="portfolio-nav nav"> <!-- Filter Buttons -->
        <li class="nav-item">
            <a class="nav-link filter-button active" href="javascript:void(0);" data-filter="<?php echo strtolower(get_theme_mod('btn_filter1', 'All')); ?>"><?php echo get_theme_mod('btn_filter1', 'All'); ?></a>
        </li>
        <li class="nav-item">
        <a class="nav-link filter-button" href="javascript:void(0);" data-filter="<?php echo strtolower(get_theme_mod('btn_filter2', 'Development')); ?>"><?php echo get_theme_mod('btn_filter2', 'Development'); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link filter-button" href="javascript:void(0);" data-filter="<?php echo strtolower(get_theme_mod('btn_filter3', 'Design')); ?>"><?php echo get_theme_mod('btn_filter3', 'Design'); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link filter-button" href="javascript:void(0);" data-filter="<?php echo strtolower(get_theme_mod('btn_filter4', 'Others')); ?>"><?php echo get_theme_mod('btn_filter4', 'Others'); ?></a>
        </li>
        </ul> <!-- End Filter Buttons -->
        ...
        <?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
            <a href="<?php echo get_permalink( $post->ID ); ?>">
                <div class="mb-3 filter <?php the_field('category'); ?>">
                    <div class="img-container">
                        <?php if( get_field('preview_img') ): ?>
                        <img class="img-fluid portfolio-img" src="<?php the_field('preview_img'); ?>">
                        <?php endif; ?>
                        <div class="overlay">
                            <p class="img-hover-subtitle"><?php the_field('category'); ?></p>
                            <p class="img-hover-title"><?php the_field('title'); ?></p>
                        </div>
                    </div>
                </div>
            </a>
